...
def test_case_add(login_fixture, base_url, random_fixture, field_search_fixture, classId_search_fixture):
    r = case_add(login_fixture, base_url, case_name = random_fixture("案例"), rich_text_content = "", edit_type = "1",
                 ...
                 open_field_id = field_search_fixture, markdown_content = random_fixture("内容"))
    print(r.text)
